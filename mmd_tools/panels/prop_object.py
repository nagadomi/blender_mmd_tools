...
class MMDModelObjectPanel(_PanelBase, Panel):
    ...
    def draw(self, context):
        ...
        c = layout.column()
        c.prop_search(root.mmd_root, 'comment_text_ref', search_data=bpy.data, search_property='texts')
        c.prop_search(root.mmd_root, 'comment_e_text_ref', search_data=bpy.data, search_property='texts')
        c = layout.column()
